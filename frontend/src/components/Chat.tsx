            ...
            <div className = "flex flex-row w-9/12 h-96"> 
                ...
                <div className = "bg-gray-800 flex flex-1 overflow-y-scroll flex-col no-scrollbar" id ="chat-window">
                   {chatLog.map((chatmsg, index) =>{
                           ...
                           return <div key ={index} className="flex flex-wrap mx-4 my-3 self-end w-64">
                               
                               <p className= "bg-yellow-600 rounded-md text-sm  text-white p-2 flex flex-col w-full">
                                    <div className ="text-xs"> {chatmsg.username}</div>
                                    <div>{chatmsg.message}</div>
                                    <div className = "text-xs self-end"> {chatmsg.date}</div>
                               </p>
                           </div> 
